...
// fnsrc/plan-reminder.mjs
var plan_reminder_default = async () => {
  const res = await sendToAll("\u{1F319} Plan tomorrow", "Two minutes: line out tomorrow before you knock off. Open Boiler Room.", "plan");
  return Response.json(res);
};
export {
  plan_reminder_default as default
};
